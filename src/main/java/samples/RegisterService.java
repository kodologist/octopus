...
/**
 * Sample Code for Service Registration using JmDNS. <p> To see what happens, launch the TTY browser
 * of JmDNS using the following command:
 * <pre>
 * java -jar lib/jmdns.jar -bs _http._tcp local.
 * </pre>
 * Then run the main method of this class. When you press 'r' and enter, you should see the
 * following output on the TTY browser:
 * <pre>
    ...
    */
    ...
    try {
      ...
      ServiceInfo info = ServiceInfo
          .create("_http._tcp.local.", "foo", 1268, 0, 0, "path=index.html");
