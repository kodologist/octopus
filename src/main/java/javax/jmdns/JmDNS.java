...
public abstract class JmDNS {
  ...
  /**
   * Get service information. If the information is not cached, the method will block until
   * updated information is received. <p/> Usage note: Do not call this method from the AWT event
   * dispatcher thread. You will make the user interface unresponsive.
   *
  ...
  /**
   * Get service information. If the information is not cached, the method will block for the
   * given timeout until updated information is received. <p/> Usage note: If you call this method
   * from the AWT event dispatcher thread, use a small timeout, or you will make the user
   ...
   * ServiceListener.resolveService method is called as soon as it is available. <p/> Usage note:
   * Do not call this method from the AWT event dispatcher thread. You will make the user
   * interface unresponsive.
   *
   * @param type full qualified service type, such as <code>_http._tcp.local.</code> .
   * @param name unqualified service name, such as <code>foobar</code> .
