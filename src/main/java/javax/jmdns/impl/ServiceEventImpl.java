...
public class ServiceEventImpl extends ServiceEvent {
  ...
  private String type;
  /**
   * The instance name of the service. Or null, if the event was fired to a service type
   * listener.
   */
  private String name;
  /**
   * The service info record, or null if the service could be be resolved. This is also null, if
   * the event was fired to a service type listener.
   */
