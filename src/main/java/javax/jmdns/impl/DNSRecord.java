...
public abstract class DNSRecord extends DNSEntry {
  ...
  /**
   * True if this record would be supressed by an answer. This is the case if this record would
   * not have a significantly longer TTL.
   */
  ...
  static class Address extends DNSRecord {
    ...
    boolean handleQuery(JmDNSImpl dns, long expirationTime) {
      ...
      if (dnsAddress != null) {
        if (dnsAddress.sameType(this) && dnsAddress.sameName(this) && (!dnsAddress
            .sameValue(this))) {
  ...
  public static class Service extends DNSRecord {
    ...
    public Service(String name, int type, int clazz, int ttl, int priority, int weight, int port,
        String server) {
      super(name, type, clazz, ttl);
    ...
    boolean sameValue(DNSRecord other) {
      ...
      return (priority == s.priority) && (weight == s.weight) && (port == s.port) && server
          .equals(s.server);
    }
  ...
  public String toString(String other) {
    return toString("record",
        ttl + "/" + getRemainingTTL(System.currentTimeMillis()) + "," + other);
  }
