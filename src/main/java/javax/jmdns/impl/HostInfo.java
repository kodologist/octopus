...
public class HostInfo {
  ...
  DNSRecord.Address getDNSAddressRecord(DNSRecord.Address address) {
    return (DNSConstants.TYPE_AAAA == address.type ? getDNS6AddressRecord()
  ...
  public DNSRecord.Address getDNS4AddressRecord() {
    if ((getAddress() != null) &&
      ...
      return new DNSRecord.Address(getName(), DNSConstants.TYPE_A, DNSConstants.CLASS_IN,
  ...
  public DNSRecord.Address getDNS6AddressRecord() {
    if ((getAddress() != null) && (getAddress() instanceof Inet6Address)) {
      return new DNSRecord.Address(getName(), DNSConstants.TYPE_AAAA, DNSConstants.CLASS_IN,
          DNSConstants.DNS_TTL, getAddress());
    }
    return null;
  }
