          ...
          for (Iterator iterator = in.getQuestions().iterator(); iterator.hasNext(); ) {
            ...
            if (entry instanceof DNSQuestion) {
              ...
              if (type == DNSConstants.TYPE_ANY || type
                  == DNSConstants.TYPE_SRV) { // I ama not sure of why there is a special case here [PJYF Oct 15 2004]
              ...
              switch (type) {
                ...
                case DNSConstants.TYPE_PTR: {
                  ...
                  for (Iterator serviceIterator = this.jmDNSImpl.getServices().values().iterator();
                  ...
                  if (q.getName().equalsIgnoreCase("_services._mdns._udp.local.")) {
                    for (Iterator serviceTypeIterator = this.jmDNSImpl.getServiceTypes().values()
                        .iterator(); serviceTypeIterator.hasNext(); ) {
                ...
                case DNSConstants.TYPE_TXT: {
                  ServiceInfoImpl info = (ServiceInfoImpl) this.jmDNSImpl.getServices()
                      .get(q.getName().toLowerCase());
