...
public class DNSState implements Comparable {
  ...
  /**
   * Logical sequence of states. The sequence is consistent with the ordinal of a state. This is
   * used for advancing through states.
   */
  ...
  /**
   * Returns the next advanced state. In general, this advances one step in the following
   * sequence: PROBING_1, PROBING_2, PROBING_3, ANNOUNCING_1, ANNOUNCING_2, ANNOUNCED. Does not
   * advance for ANNOUNCED and CANCELED state.
   */
  ...
  /**
   * Compares two states. The states compare as follows: PROBING_1 &lt; PROBING_2 &lt; PROBING_3
   * &lt; ANNOUNCING_1 &lt; ANNOUNCING_2 &lt; RESPONDING &lt; ANNOUNCED &lt; CANCELED.
   */
