...
public abstract class ServiceInfo {
  ...
  /**
   * Get the text for the service. This will interpret the text bytes as a UTF8 encoded string.
   * Will return null if the bytes are not a valid UTF8 encoded string.
   */
  ...
  /**
   * Get a property of the service. This involves decoding the text bytes into a property list.
   * Returns null if the property is not found, the text data could not be decoded correctly, or
